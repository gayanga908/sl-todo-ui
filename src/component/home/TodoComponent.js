  ...
  if (status === "Done") {
    button = (
      ...
      >
        ...
        <span className="visually-hidden">Mark pending Button</span>
      </button>
    );
  } else {
    button = (
      ...
      >
        ...
        <span className="visually-hidden">Mark done Button</span>
      </button>
    );
  }
            ...
            <div className="col-md-3 col-sm-12 action-column">
              ...
              >
                ...
                >
                  ...
                  <span className="visually-hidden">View Button</span>
                </button>
